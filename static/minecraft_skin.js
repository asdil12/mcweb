...
function draw_model_left(canvas_id,scratch_id,username,scale,hat) {
	...
	var skin = new Image();
	//skin.src = 'http://s3.amazonaws.com/skins/' + username + '.png' - Causes DOM Security Errors. So I made a php script that grabs it instead.
	skin.src = '/skins/' + username + '.png';
...
function draw_head(canvas_id,username,scale) {
	...
	head_original.src = '/skins/' + username + '.png';
